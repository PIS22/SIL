...
public class CommuneController {
	...
	public CommuneController(ExerciceService exerciceService, FournisseurService fournisseurService,
			...
			PaysService paysService, DepartementService departementService, CommuneService communeService,
	...
	public Fonction getFonctionById(@PathVariable(name = "id") String id) {

		return this.fonctionService.find(id);
	}
	...
	public AffectDroitGroupUser updatedroitGroup(@PathVariable(name = "id") Long id,
			@RequestBody AffectDroitGroupUser adgu) {
	...
	public Arrondissement updateArrondissement(@PathVariable(name = "id") String id,
			@RequestBody Arrondissement arrondissement) {
	...
	public AffectUserToArrondi updateUserArrondi(@PathVariable(name = "id") Long id,
			@RequestBody AffectUserToArrondi userArrondi) {
